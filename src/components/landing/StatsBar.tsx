import { Bookmark, Eye, ShoppingCart, ShoppingBag, Sparkles } from "lucide-react";
  ...
  return (
    <section>
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 gap-6 rounded-2xl bg-white px-6 py-8 shadow-xl sm:grid-cols-3 sm:gap-4 sm:px-10 lg:grid-cols-5">
